...
<head>
    ...
    <title>Login Aplikasi Persedian Jilbab</title>
    <link rel="shortcut icon" href="<?= base_url('assets/img/logo1.jpeg'); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                ...
                <h3 class="text-white mt-2">Aplikasi Persedian Jilbab</h3>
